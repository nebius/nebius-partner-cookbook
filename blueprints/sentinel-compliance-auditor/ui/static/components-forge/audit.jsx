...
// Agent labels/graph ids/pricing come from /agents.js (window.SENTINEL_AGENTS),
// generated by ui/server.py from one registry + config.PRICING.
const AUDIT_AGENTS = (window.SENTINEL_AGENTS || {}).audit || [];
...
// truncate / summarizeArgs / Th / Td / TraceLink come from primitives.jsx
